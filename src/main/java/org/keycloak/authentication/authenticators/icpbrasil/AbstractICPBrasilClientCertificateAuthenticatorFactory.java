...
public abstract class AbstractICPBrasilClientCertificateAuthenticatorFactory implements AuthenticatorFactory {
    ...
    private static final String[] mappingSources = {
            ...
            MAPPING_SOURCE_CERT_SUBJECT_CPF,
            MAPPING_SOURCE_CERT_SUBJECT_CNPJ,
            MAPPING_SOURCE_CERT_SUBJECT_CPF_CNPJ
    };
