...
import static org.keycloak.authentication.authenticators.icpbrasil.AbstractICPBrasilClientCertificateAuthenticator.*;
...
public class ICPBrasilAuthenticatorConfigModel extends AuthenticatorConfigModel {
    ...
    public enum MappingSourceType {
        ...
        SUBJECTCPF(MAPPING_SOURCE_CERT_SUBJECT_CPF),
        SUBJECTCNPJ(MAPPING_SOURCE_CERT_SUBJECT_CNPJ),
        SUBJECTCPFCNPJ(MAPPING_SOURCE_CERT_SUBJECT_CPF_CNPJ);
    ...
    public ICPBrasilAuthenticatorConfigModel(AuthenticatorConfigModel model) {
    ...
    public ICPBrasilAuthenticatorConfigModel setCRLEnabled(boolean value) {
    ...
    public ICPBrasilAuthenticatorConfigModel setOCSPEnabled(boolean value) {
    ...
    public ICPBrasilAuthenticatorConfigModel setCRLDistributionPointEnabled(boolean value) {
    ...
    public ICPBrasilAuthenticatorConfigModel setCRLRelativePath(String path) {
        if (path != null) {
    ...
    public ICPBrasilAuthenticatorConfigModel setOCSPResponder(String responderUri) {
    ...
    public ICPBrasilAuthenticatorConfigModel setMappingSourceType(MappingSourceType value) {
    ...
    public ICPBrasilAuthenticatorConfigModel setUserIdentityMapperType(IdentityMapperType value) {
    ...
    public ICPBrasilAuthenticatorConfigModel setRegularExpression(String value) {
        if (value != null) {
    ...
    public ICPBrasilAuthenticatorConfigModel setCustomAttributeName(String value) {
        if (value != null) {
    ...
    public ICPBrasilAuthenticatorConfigModel setKeyUsage(String value) {
        if (value != null) {
    ...
    public ICPBrasilAuthenticatorConfigModel setExtendedKeyUsage(String value) {
        if (value != null) {
    ...
    public ICPBrasilAuthenticatorConfigModel setConfirmationPageDisallowed(boolean value) {
        getConfig().put(CONFIRMATION_PAGE_DISALLOWED, Boolean.toString(value));
        return this;
    }

    public ICPBrasilAuthenticatorConfigModel setConfirmationPageAllowed(boolean value) {
        getConfig().put(CONFIRMATION_PAGE_DISALLOWED, Boolean.toString(!value));
        return this;
    }
